...
pdf.sub_title('Auto Send Mode')
pdf.bullet_point('Customer gets instant price for covered routes')
pdf.bullet_point('RFQ prices go directly to customer after vendors reply')
pdf.bullet_point('Fastest mode, least admin work')
pdf.bullet_point('Best for: Established routes with trusted pricing')

pdf.sub_title('Manual Approval Mode')
pdf.bullet_point('Everything stays pending for admin review')
pdf.bullet_point('Even RFQ results wait for your approval')
pdf.bullet_point('Maximum control over every quote')
pdf.bullet_point('Best for: New business, testing, or high-value shipments')

pdf.sub_title('Low Confidence Only')
pdf.bullet_point('Auto-sends for high-confidence parsing results')
pdf.bullet_point('Keeps low-confidence results pending for review')
pdf.bullet_point('Balanced approach between speed and control')
pdf.ln(3)
